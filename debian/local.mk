...
debian/stamp/build/policycoreutils:
	...
	bash -n debian/policycoreutils.preinst
	bash -n debian/policycoreutils.postinst
	bash -n debian/policycoreutils.prerm
	bash -n debian/policycoreutils.postrm
...
debian/stamp/install/policycoreutils:
	...
	cp	-r mcstrans/share/examples	$(DOCDIR)/mcstrans-examples
...
debian/stamp/binary/policycoreutils:
	...
	$(install_script)    debian/policycoreutils.postinst        $(TMPTOP)/DEBIAN/postinst
	$(install_script)    debian/policycoreutils.preinst         $(TMPTOP)/DEBIAN/preinst 
	$(install_script)    debian/policycoreutils.prerm           $(TMPTOP)/DEBIAN/prerm
	$(install_script)    debian/policycoreutils.postrm          $(TMPTOP)/DEBIAN/postrm
	$(get-shlib-deps)
